...
public class SearchActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        AppLog.logDebug(TAG, "onCreate: starts");
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_search);
        
        activateToolbar(true);
        AppLog.logDebug(TAG, "onCreate: ends");
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        mSearchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                AppLog.logDebug(TAG, "onQueryTextSubmit: called");
            ...
            public boolean onQueryTextChange(String newText) {
                AppLog.logDebug(TAG, "onQueryTextChange: called");
                return false;
            }
        });
        ...
        AppLog.logDebug(TAG, "onCreateOptionsMenu: returned true");
